...
**Last Updated:** 2026-01-12 03:57 UTC  
**Commit:** `unknown`
...
- **Qwen/Qwen3-0.6B** (RL Full) on 2xA6000: Unknown error
- **Qwen/Qwen3-0.6B** (SFT Full) on 2xA6000: Unknown error
- **Qwen/Qwen3-4B** (SFT Full) on 2xHBM3: Unknown error
- **Qwen/Qwen3-0.6B** (RL LoRA(r=16)) on 2xHBM3: Unknown error
- **Qwen/Qwen3-4B** (RL Full) on 2xHBM3: Unknown error
- **Qwen/Qwen3-4B** (RL LoRA(r=16)) on 2xHBM3: Unknown error
- **Qwen/Qwen3-0.6B** (RL LoRA(r=16)) on 2xA6000: Unknown error
- **Qwen/Qwen3-0.6B** (RL Full) on 2xHBM3: Unknown error
- **Qwen/Qwen3-0.6B** (SFT Full) on 2xHBM3: Unknown error
